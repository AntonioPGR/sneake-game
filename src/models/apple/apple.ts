export class Apple{
  ...
  // ACTIONS
  public raffleNewPosition(invalid_positions?: TPosition[]) {
    let new_position;
  ...
  private isPositionValid(position: TPosition, invalid_positions?: TPosition[]) {
  ...
  private setPosition(position:TPosition) {
